...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredApps = this.getFliteredApps()

    const serachResults = filteredApps.filter(searchEachApp =>
      searchEachApp.appName.toLowerCase().includes(searchInput),
    )
        ...
        <div className="app-store-container">
          ...
          <div>
            <input
              ...
              onChange={this.onSearchInputEnter}
              value={searchInput}
            />
            <img
